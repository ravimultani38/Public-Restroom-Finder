                ...
                <ul>
                    {closestBathrooms.map((bathroom, index) => (
                        <li key={index}>
                            ...
                            Hours: {bathroom.hours}<br />
                            Distance: {bathroom.distance.toFixed(2)} miles<br />
                            <button className="btn btn-secondary" onClick={() => navigateToBathroom(bathroom)}>Navigate</button>
                        </li>
                    ))}
                </ul>
            </div>
